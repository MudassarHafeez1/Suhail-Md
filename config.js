...
global.caption = process.env.CAPTION || global.caption || "ᴘᴏᴡᴇʀᴇᴅ BY MHking 👑" 
...
module.exports = {
  ...
  ownername:process.env.OWNER_NAME|| "Mudassarking",
  ...
  LANG: ( process.env.THEME ||  "MHking"  ).toUpperCase(),
